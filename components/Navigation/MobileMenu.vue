<template>
  <div>
    ...
    ></div>
    <ul
      class="p-8 fixed transform inset-y-0 md:hidden right-0 w-56 bg-white dark:bg-gray-900 flex flex-col justify-center transition-all duration-300 z-20 overflow-hidden"
      :class="{
